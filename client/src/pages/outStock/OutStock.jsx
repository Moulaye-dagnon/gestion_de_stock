...
import useOutStock from "../../hooks/useOutStock";
import columnSortieStock from "../../tanStack/Columns/OutStockColumn";
...
export function OutStock() {
  ...
  return (
    <>
      <div className=" flex-1 overflow-auto   flex flex-col py-2.5 px-1.5 bg-white ">
        <div className="flex justify-between py-1.5">
          <div className=" uppercase"> Sortie de produit</div>
          <div className="flex  items-center">
            <ButtonComponent
              handleClick={handleHideAddSortieComponent}
                  ...
                  <tr key={row.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500">
                      <NavLink
                        ...
                        to={`/stock/sortie/${row.original.id}/detail`}
                      >
      ...
      {AddSortieComponent && (
        <AddSortieStockComponent
          usernameId={user.id}
          setAddSortieComponent={setAddSortieComponent}
        />
      )}
    </>
  );
