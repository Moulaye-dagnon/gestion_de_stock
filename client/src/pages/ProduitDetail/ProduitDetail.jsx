  ...
  return (
    <div className=" flex-1 flex flex-col m-3 bg-white p-4">
      <div className="flex justify-between items-center ">
        ...
        <button className="border-2 hover:bg-my-primary hover:border-my-primary rounded-sm text border-my-border py-2.5 px-4 flex items-center">
      ...
      <div className=" flex-1 flex flex-col  px-10 py-8">
        <div className="flex flex-col">
          ...
          <div>
            <div className="text-xl font-bold mb-5 ">Detail du fournisseur</div>
            ...
            <div>
              ...
              <div className="flex justify-between items-center mb-10">
                ...
                <span className="text-lg text-gray-600">{data.telephone}</span>
              </div>
            </div>
          </div>
        </div>
