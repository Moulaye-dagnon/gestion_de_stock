...
function OverallComponent({ title = "Inventaire global" }) {
  ...
  return (
    <div className=" flex flex-col bg-white rounded-md py-4  px-3 w-full ">
      ...
      <div className="flex justify-between divide-x-1 divide-my-border items-center">
        ...
        <div className="flex-none w-2/6 flex  flex-col gap-y-3">
          <span
            style={{ color: "#E19133" }}
        ...
        <div className="flex-none w-2/6 flex  flex-col gap-y-3">
          ...
          <div className=" flex justify-between items-center">
            <div className=" flex flex-col ">
              ...
              <span className=" text-my-handing text-sm">Faible</span>
            </div>
            <div className=" flex flex-col items-end ">
              <span className=" text-my-handing text-lg">
                {data.FinishedProduit}
              </span>
              <span className=" text-my-handing text-sm">épuisée</span>
            </div>
          </div>
        </div>
      </div>
